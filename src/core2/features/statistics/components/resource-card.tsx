...
import { getEndpointMethod, getMethodColor, getMethodIcon } from "../../../utils/endpoint-helpers";
...
export function ResourceCard({ resourceKey, resourceConfig }: ResourceCardProps) {
